...
function parseSearchResults(snapshot, keyword, category) {
  ...
  for (let i = 0; i < lines.length; i++) {
    ...
    // 1. 找到 link 行（标题）
    // 格式: - link "标题" [ref=eN] [cursor=pointer]:
    ...
    // 2. 找到 URL 行（紧随 link 行之后）
    // 格式: - /url: http://www.ccgp.gov.cn/...
...
async function main() {
  console.log('╔══════════════════════════════════════════════════════════════╗');
  console.log('║           政府采购信息采集 v3                                   ║');
  console.log('║     改进：学校关键词过滤 + URL完整性校验 + 正确URL格式           ║');
  console.log('╚══════════════════════════════════════════════════════════════╝');
